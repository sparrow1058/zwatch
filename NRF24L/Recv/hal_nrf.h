 ...
 * the file.
 *
 * $LastChangedRevision: 3709 $
 */ 

/** @file
 * Interface for nRF HAL
 * @defgroup nordic_hal_nrf nRF24L01+ RF Tranceiver
 * @{
 * @ingroup nordic_hal
 * 
 * @brief Interface functions for the Nordic Semiconductor on-chip radio transceiver. 
 * 
 ...
 * (Enhanced ShockBurstâ„¢) that is found in the nRF24L01+ single chip RF Transceiver.
 *
