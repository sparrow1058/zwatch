...
#define INTERRUPT_TF0 			1		//Timer 0 overflow interrupt
#define INTERRUPT_POFIRQ 		2		//Power Failure interrupt
#define INTERRUPT_TF1 			3		//Timer 1 overflow interrupt
#define INTERRUPT_RI0 			4		//Serial channel receive interrupt
#define INTERRUPT_TI0 			5		//Serial channel transmit interrupt
#define INTERRUPT_TF2 			6		//Timer 2 overflow interrupt
#define INTERRUPT_EXF2 			7		//Timer 2 external reload
#define INTERRUPT_RFRDY 		8		//RF SPI ready
#define INTERRUPT_RFIRQ 		9		//RF IRQ
#define INTERRUPT_MSDONE 		10		//Master SPI transaction completed
#define INTERRUPT_WIRE2IRQ 		11		//2-Wire transaction completed
#define INTERRUPT_SSDONE 		12		//Slave SPI transaction completed
#define INTERRUPT_WUOPIRQ 		13		//Wakeup on pin interrupt
#define INTERRUPT_MISCIRQ 		14		//Miscellaneous interrupt is the sum of:
											//OSC16M started (X16IRQ)
											//ADC Ready (ADCIRQ) interrupt
											//RNG ready (RNGIRQ) interrupt
#define INTERRUPT_TICK 			15		//Internal Wakeup (from RTC2) interrupt
